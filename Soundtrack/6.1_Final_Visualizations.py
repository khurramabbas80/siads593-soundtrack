...
# NOTE: Two draft ridge-plot attempts below reference feature_idx / group_idx / GROUP_NUDGE
# which are not defined until Step 1.6 further down. Skipped here; see final chart below.
import altair as alt
